...
const SocialMedia = () => {
  ...
  return (
    <Container>
      <p className='text-[#5390D9] text-center element mobile:text-[32px] text-[96px] font-bold mb-[27px] mt-[100px] mobile:mt-10'>
      ...
      <Fade left>
        <div className='h-[430px] mb-[79px] relative mobile:h-[340px]'>
          <div className='absolute top-0 bg-[#5390D9] mobile:rounded-b-[0] h-[351px] mobile:h-[301px] mobile:p-[20px] px-[30px] pt-[45px] pb-[54px] rounded-[30px] w-full z-20'>
