...
const AboutUs = () => {
  ...
  return (
    <Container>
      <p className='text-center text-[#000814] text-[64px] font-semibold mb-[51px] mobile:mb-8 mt-[129px] mobile:mt-14 px-[130px] mobile:text-[26px] mobile:px-0  '>
        {t("aboutTitle")}
      </p>
      <p className='text-center text-[#000814] text-[32px] px-[80px] mb-[109px] mobile:text-[20px] mobile:px-0 mobile:mb-10'>
        {t("aboutText")}
      </p>
