...
const Branding = () => {
  ...
  return (
    <Container>
      <p className='text-[#5390D9] text-center text-[96px] font-bold mb-[27px] mobile:text-[32px] mobile:mt-10 mt-[100px]'>
        Branding
      </p>
      ...
      <div className='h-[430px] mb-[90px] relative mobile:h-[340px]'>
        <div className='absolute top-0 bg-[#5390D9] h-[351px] mobile:rounded-b-[0] mobile:h-[301px] mobile:p-[20px] pl-[60px] pt-[45px] pb-[54px] rounded-[30px] w-full z-20'>
          <p className='text-white text-[85px] font-semibold mb-7 mobile:text-[32px] mobile:mb-3 leading-[1]'>
            {t("userExperiance")}
          </p>
          <p className='text-[24px] text-white mobile:text-[16px]'>
